...
- core patch: toggle this checkbox if you have applied one of the 2 core 
  ...
  fieldset on the block configuration page. 
  Note 1: if you didn't apply a core patch, these additional settings simply won't have any effect.
  Note 2: When you see the additional settings, you can either choose between node actions or a 
          minimum cache lifetime, not both.
